...
#   Edited by b0nd for error "EncodingError: Content-Type malformed, not allowed: 'multipart/related'; {'type': 'text/html'} (Python ERROR: __init__() got multiple values for keyword argument 'type'"
#   Was receiving this error on sending mail with HTML image in it.
#   https://github.com/jpochyla/lamson/commit/498bcdfe543adf3c926d1ad8155d078c48cac482
